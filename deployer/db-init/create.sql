...
CREATE TABLE ORDERS (ORDER_ID BIGINT AUTO_INCREMENT NOT NULL, TENANT_ID VARCHAR(12), CLOSE_TIME DATETIME, COMMENT VARCHAR(255), CREATE_TIME DATETIME NOT NULL, CURRENCY VARCHAR(255), DEPOSIT FLOAT, DINNER_TIME DATETIME NOT NULL, DISCOUNT DECIMAL(38), IS_TAKE_OUT TINYINT(1) default 0, MAIN_TABLE_NUMBER VARCHAR(32), OTHER_FEE FLOAT, OWNER_ID BIGINT NOT NULL, PROMOTION_NAME VARCHAR(128), SERVICE_FEE FLOAT, STATUS VARCHAR(32), STORE_CODE VARCHAR(255) NOT NULL, TOTAL_PAYMENT DECIMAL(38), TOTAL_PAYMENT_AFTER_DISCOUNT DECIMAL(38), PRIMARY KEY (ORDER_ID))
