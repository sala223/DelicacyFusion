...
CREATE TABLE ORDER_LINE (COMMENT VARCHAR(255), DISCOUNT DECIMAL(38), ITEM_CODE VARCHAR(255) NOT NULL, LINE_NUMBER INTEGER NOT NULL, PRICE FLOAT, PROMOTION_NAME VARCHAR(255), PROMOTION_PRICE FLOAT, QUANTITY INTEGER, TABLE_CODE VARCHAR(255), TOTAL_PAYMENT DECIMAL(38), TOTAL_PAYMENT_AFTER_DISCOUNT DECIMAL(38), ORDER_ID BIGINT)
