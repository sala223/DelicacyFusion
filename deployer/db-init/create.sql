...
CREATE TABLE DINING_TABLE (TENANT_CODE VARCHAR(12) NOT NULL, CODE VARCHAR(255) NOT NULL, STORE_CODE VARCHAR(64) NOT NULL, BAR_CODE VARCHAR(128), CAPACITY INTEGER, CHANGED_TIME DATETIME, CREATED_BY BIGINT, CREATED_TIME DATETIME NOT NULL, IS_ENABLED TINYINT(1) default 0, PRIMARY KEY (TENANT_CODE, CODE, STORE_CODE))
...
CREATE TABLE ITEM (TENANT_CODE VARCHAR(12) NOT NULL, CODE VARCHAR(255) NOT NULL, STORE_CODE VARCHAR(64) NOT NULL, CHANGED_TIME DATETIME, CREATED_BY BIGINT, CREATED_TIME DATETIME NOT NULL, IS_ENABLED TINYINT(1) default 0, PRICE FLOAT, PRIMARY KEY (TENANT_CODE, CODE, STORE_CODE))
...
CREATE TABLE PROMOTION (TENANT_CODE VARCHAR(12) NOT NULL, CODE VARCHAR(255) NOT NULL, STORE_CODE VARCHAR(64) NOT NULL, CHANGED_TIME DATETIME, CREATED_BY BIGINT, CREATED_TIME DATETIME NOT NULL, DETAILS VARCHAR(255) NOT NULL, IS_ENABLED TINYINT(1) default 0, NAME VARCHAR(128) NOT NULL, QUALIFIER VARCHAR(128) NOT NULL, PROMOTION_TYPE VARCHAR(255) NOT NULL, VALID_FROM DATETIME NOT NULL, VALID_TO DATETIME NOT NULL, PRIMARY KEY (TENANT_CODE, CODE, STORE_CODE))
CREATE TABLE ROOM (TENANT_CODE VARCHAR(12) NOT NULL, CODE VARCHAR(255) NOT NULL, STORE_CODE VARCHAR(64) NOT NULL, CHANGED_TIME DATETIME, CREATED_BY BIGINT, CREATED_TIME DATETIME NOT NULL, CURRENCY VARCHAR(255), DESCRIPTION VARCHAR(1024), IS_ENABLED TINYINT(1) default 0, MINIMUM_COST DOUBLE, NAME VARCHAR(255) NOT NULL, PRIMARY KEY (TENANT_CODE, CODE, STORE_CODE))
...
CREATE TABLE USERS (ID BIGINT AUTO_INCREMENT NOT NULL, AGE INTEGER, CELL_PHONE VARCHAR(20), CHANGED_TIME DATETIME, CREATED_TIME DATETIME NOT NULL, EMAIL VARCHAR(128) NOT NULL, FIRST_NAME VARCHAR(128), GENDER VARCHAR(8), IMAGE_ID VARCHAR(512), IS_CELL_PHONE_VERIFIED TINYINT(1) default 0, IS_EMAIL_VERIFIED TINYINT(1) default 0, LAST_NAME VARCHAR(128), LOCKED TINYINT(1) default 0, NICK_NAME VARCHAR(128), PASSWORD VARCHAR(256) NOT NULL, PRIMARY KEY (ID))
CREATE UNIQUE INDEX INDEX_USERS_CELL_PHONE ON USERS (CELL_PHONE)
...
CREATE TABLE RULE_PARAMETER (NAME VARCHAR(32) NOT NULL, VALUE VARCHAR(128) NOT NULL, STORE_CODE VARCHAR(64), PROMOTION_CODE VARCHAR(255), TENANT_CODE VARCHAR(12))
CREATE TABLE PROMOTION_CATEGORY (STORE_CODE VARCHAR(64), PROMOTION_CODE VARCHAR(255), TENANT_CODE VARCHAR(12), CATEGORY_CODE VARCHAR(255))
CREATE TABLE PROMOTION_ITEM (STORE_CODE VARCHAR(64), PROMOTION_CODE VARCHAR(255), TENANT_CODE VARCHAR(12), ITEM_CODE VARCHAR(255))
CREATE TABLE ROOM_TABLE (STORE_CODE VARCHAR(64) NOT NULL, ROOM_CODE VARCHAR(255) NOT NULL, TENANT_CODE VARCHAR(12) NOT NULL, TABLE_CODE VARCHAR(255) NOT NULL UNIQUE, PRIMARY KEY (STORE_CODE, ROOM_CODE, TENANT_CODE, TABLE_CODE))
...
CREATE TABLE EXTERNAL_USER_REFERENCE (EXTERNAL_ID VARCHAR(128) UNIQUE, PROVIDER VARCHAR(32) UNIQUE, USER_ID BIGINT)
...
ALTER TABLE RULE_PARAMETER ADD CONSTRAINT FK_RULE_PARAMETER_TENANT_CODE FOREIGN KEY (TENANT_CODE, PROMOTION_CODE, STORE_CODE) REFERENCES PROMOTION (TENANT_CODE, CODE, STORE_CODE)
ALTER TABLE PROMOTION_CATEGORY ADD CONSTRAINT FK_PROMOTION_CATEGORY_TENANT_CODE FOREIGN KEY (TENANT_CODE, PROMOTION_CODE, STORE_CODE) REFERENCES PROMOTION (TENANT_CODE, CODE, STORE_CODE)
ALTER TABLE PROMOTION_ITEM ADD CONSTRAINT FK_PROMOTION_ITEM_TENANT_CODE FOREIGN KEY (TENANT_CODE, PROMOTION_CODE, STORE_CODE) REFERENCES PROMOTION (TENANT_CODE, CODE, STORE_CODE)
ALTER TABLE ROOM_TABLE ADD CONSTRAINT FK_ROOM_TABLE_TENANT_CODE FOREIGN KEY (TENANT_CODE, ROOM_CODE, STORE_CODE) REFERENCES ROOM (TENANT_CODE, CODE, STORE_CODE)
...
ALTER TABLE EXTERNAL_USER_REFERENCE ADD CONSTRAINT FK_EXTERNAL_USER_REFERENCE_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS (ID)
