...
INSERT INTO `delicacy_fusion`.`room` (ID, CHANGED_TIME, CODE, CREATED_BY, CREATED_TIME, CURRENCY, DESCRIPTION, IS_ENABLED, MINIMUM_COST, NAME, STORE_CODE, TENANT_ID) VALUES (1, null, '大堂', 0, '2013-10-20 14:39:43.828', null, null, 1, 0.0, 'A004', 'S1', 'test');
INSERT INTO `delicacy_fusion`.DINING_TABLE (BAR_CODE, CAPACITY, CODE, IS_ENABLED, STORE_CODE,TENANT_ID,CREATED_TIME) VALUES ('TV10001', 10, 'S1000001',1, 'S1', 'TEST','2013-01-02 09:22:22');
INSERT INTO `delicacy_fusion`.DINING_TABLE (BAR_CODE, CAPACITY, CODE, IS_ENABLED, STORE_CODE,TENANT_ID,CREATED_TIME) VALUES ('TV10002', 10, 'S1000002',1, 'S1', 'TEST','2013-01-02 09:22:22');
INSERT INTO `delicacy_fusion`.DINING_TABLE (BAR_CODE, CAPACITY, CODE, IS_ENABLED, STORE_CODE,TENANT_ID,CREATED_TIME) VALUES ('TV10003', 10, 'S1000003',1, 'S1', 'TEST','2013-01-02 09:22:22');
