...
INSERT INTO `delicacy_fusion`.`category` (`TENANT_ID`, `CODE`, `CREATED_BY`, `CREATED_TIME`, `IS_ENABLED`, `NAME`) VALUES ('test', 'SYS00001', '0', '2013-11-10 14:21:34', '1', '');
INSERT INTO `delicacy_fusion`.`category` (`TENANT_ID`, `CODE`, `CREATED_BY`, `CREATED_TIME`, `IS_ENABLED`, `NAME`) VALUES ('test', 'SYS00002', '0', '2013-11-10 14:21:34', '1', '');
INSERT INTO `delicacy_fusion`.`category` (`TENANT_ID`, `CODE`, `CREATED_BY`, `CREATED_TIME`, `IS_ENABLED`, `NAME`) VALUES ('test', 'SYS00003', '0', '2013-11-10 14:21:34', '1', '');
INSERT INTO `delicacy_fusion`.`category` (`TENANT_ID`, `CODE`, `CREATED_BY`, `CREATED_TIME`, `IS_ENABLED`, `NAME`) VALUES ('test', 'SYS00004', '0', '2013-11-10 14:21:34', '1', '');
INSERT INTO `delicacy_fusion`.`category` (`TENANT_ID`, `CODE`, `CREATED_BY`, `CREATED_TIME`, `IS_ENABLED`, `NAME`) VALUES ('test', 'SYS00005', '0', '2013-11-10 14:21:34', '1', '');
INSERT INTO `delicacy_fusion`.`category` (`TENANT_ID`, `CODE`, `CREATED_BY`, `CREATED_TIME`, `IS_ENABLED`, `NAME`) VALUES ('test', 'SYS00006', '0', '2013-11-10 14:21:34', '1', '');
...
INSERT INTO `delicacy_fusion`.DINING_TABLE (BAR_CODE, CAPACITY, CODE) VALUES ('TV10001', 10, 'S1000001');
INSERT INTO `delicacy_fusion`.DINING_TABLE (BAR_CODE, CAPACITY, CODE) VALUES ('TV10002', 10, 'S1000002');
INSERT INTO `delicacy_fusion`.DINING_TABLE (BAR_CODE, CAPACITY, CODE) VALUES ('TV10003', 10, 'S1000003');
