...
INSERT INTO `store` (`ID`, `TENANT_ID`, `BUSINESS_HOUR_FROM`, `BUSINESS_HOUR_TO`, `CODE`, `CREATED_BY`, `CREATED_TIME`, `IS_ENABLED`, `NAME`, `TELEPHONE1`) VALUES ('2', 'TEST', '480', '1320', 'S2', '0', '2013-02-01 09:22:22', '1', ' 望湘园正大广场店', '13345453232');
INSERT INTO `store` (`ID`, `TENANT_ID`, `BUSINESS_HOUR_FROM`, `BUSINESS_HOUR_TO`, `CODE`, `CREATED_BY`, `CREATED_TIME`, `IS_ENABLED`, `NAME`, `TELEPHONE1`) VALUES ('3', 'TEST', '480', '1320', 'S3', '0', '2013-03-05 09:22:22', '1', ' 望湘园浦三路店', '13345453232');
...
INSERT INTO `item_template` (`ID`, `TENANT_ID`, `CODE`, `CREATED_BY`, `CREATED_TIME`, `DESCRIPTION`, `IS_ENABLED`, `ITEM_UNIT`, `NAME`, `PRICE`, `PRICE_UNIT`, `TYPE`) VALUES ('1', 'TEST', 'A0001', '0', '2013-09-15 08:09:21', '', '1', 'CUP', 'IceCream', '23.0', 'RMB', 'FOOD');
...
INSERT INTO `item_template_picture`(`ITEM_TEMPLATE_ID`,`IMG_ID`,`WIDTH`,`HEIGTH`,`FORMAT`) values(1, 'AAAADAAAABgABAAAACRkNGNhM2U4Yi1lMTlhLTQ4NmItYjg4YS0xMTVmNzBlZThmYTgAAAAEdGVzdA',251,201,'jpg');
INSERT INTO `item_template_picture`(`ITEM_TEMPLATE_ID`,`IMG_ID`,`WIDTH`,`HEIGTH`,`FORMAT`) values(2, 'AAAADAAAABgABAAAACRkNGNhM2U4Yi1lMTlhLTQ4NmItYjg4YS0xMTVmNzBlZThmYTgAAAAEdGVzdA',251,201,'jpg');
INSERT INTO `item_template_picture`(`ITEM_TEMPLATE_ID`,`IMG_ID`,`WIDTH`,`HEIGTH`,`FORMAT`) values(3, 'AAAADAAAABgABAAAACRkNGNhM2U4Yi1lMTlhLTQ4NmItYjg4YS0xMTVmNzBlZThmYTgAAAAEdGVzdA',251,201,'jpg');
INSERT INTO `item_template_picture`(`ITEM_TEMPLATE_ID`,`IMG_ID`,`WIDTH`,`HEIGTH`,`FORMAT`) values(4, 'AAAADAAAABgABAAAACRkNGNhM2U4Yi1lMTlhLTQ4NmItYjg4YS0xMTVmNzBlZThmYTgAAAAEdGVzdA',251,201,'jpg');
...
INSERT INTO ORDER_LINE (ORDER_ID, COMMENT, DISCOUNT, ITEM_CODE, LINE_NUMBER, PRICE, PROMOTION_NAME, PROMOTION_PRICE, QUANTITY, TABLE_CODE, TOTAL_PAYMENT, TOTAL_PAYMENT_AFTER_DISCOUNT) VALUES (1, null, 23, "A0001", 1, 23, "National day 50% discount", 12.5, 2, null, 46, 23);
INSERT INTO ORDER_LINE (ORDER_ID, COMMENT, DISCOUNT, ITEM_CODE, LINE_NUMBER, PRICE, PROMOTION_NAME, PROMOTION_PRICE, QUANTITY, TABLE_CODE, TOTAL_PAYMENT, TOTAL_PAYMENT_AFTER_DISCOUNT) VALUES (1, null, 0, "A0003", 2, 68, null, null, 1, null, 68, 68);
...
INSERT INTO ORDERS (TENANT_ID,ORDER_ID, CLOSE_TIME, COMMENT, CREATE_TIME, CURRENCY, DEPOSIT, DINNER_TIME, DISCOUNT, IS_TAKE_OUT, OTHER_FEE, OWNER_ID, PROMOTION_NAME, SERVICE_CARD_ID, SERVICE_FEE, STATUS, STORE_CODE, TOTAL_PAYMENT, TOTAL_PAYMENT_AFTER_DISCOUNT) VALUES ("test",2,null, null, "2013-11-21 13:09:48.866", null, 0.0, "2013-11-21 13:09:48.844", null, false, 0.0, 0, null, 1, 0.0, "OPEN", "S1", 74, 74);
INSERT INTO ORDER_LINE (ORDER_ID, COMMENT, DISCOUNT, ITEM_CODE, LINE_NUMBER, PRICE, PROMOTION_NAME, PROMOTION_PRICE, QUANTITY, TABLE_CODE, TOTAL_PAYMENT, TOTAL_PAYMENT_AFTER_DISCOUNT) VALUES (2, null, 23, "A0001", 1, 23, "National day 50% discount", 12.5, 2, null, 46, 23);
INSERT INTO ORDER_LINE (ORDER_ID, COMMENT, DISCOUNT, ITEM_CODE, LINE_NUMBER, PRICE, PROMOTION_NAME, PROMOTION_PRICE, QUANTITY, TABLE_CODE, TOTAL_PAYMENT, TOTAL_PAYMENT_AFTER_DISCOUNT) VALUES (2, null, 0, "A0003", 2, 68, null, null, 1, null, 68, 68);