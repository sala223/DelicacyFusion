...
CREATE TABLE ORDERS (ORDER_ID BIGINT AUTO_INCREMENT NOT NULL, TENANT_ID VARCHAR(12), CLOSE_TIME TIME, COMMENT VARCHAR(255), CREATE_TIME DATETIME NOT NULL, CURRENCY VARCHAR(255), DEPOSIT FLOAT, DINNER_TIME TIME NOT NULL, DISCOUNT FLOAT, IS_TAKE_OUT TINYINT(1) default 0, OTHER_FEE FLOAT, OWNER_ID BIGINT NOT NULL, PROMOTION_DETAILS VARCHAR(255), SERVICE_FEE FLOAT, STATUS VARCHAR(32), STORE_CODE VARCHAR(255) NOT NULL, TOTAL_PAYMENT DECIMAL(38), PRIMARY KEY (ORDER_ID))
...
CREATE TABLE PROMOTION (ID BIGINT AUTO_INCREMENT NOT NULL, TENANT_ID VARCHAR(12), CATEGORY_CODE VARCHAR(255), CHANGED_TIME DATETIME, CODE VARCHAR(255), CREATED_BY BIGINT, CREATED_TIME DATETIME NOT NULL, Details VARCHAR(255) NOT NULL, IS_ENABLED TINYINT(1) default 0, ITEM_CODE VARCHAR(255), STORE_CODE VARCHAR(255) NOT NULL, PROMOTION_TYPE VARCHAR(255) NOT NULL, VALID_FROM DATETIME NOT NULL, VALID_TO DATETIME NOT NULL, RULE_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE RULE (ID BIGINT AUTO_INCREMENT NOT NULL, TENANT_ID VARCHAR(12), CHANGED_TIME DATETIME, CODE VARCHAR(255), CREATED_BY BIGINT, CREATED_TIME DATETIME NOT NULL, IS_ENABLED TINYINT(1) default 0, RULE_CLASS VARCHAR(128) NOT NULL, STORE_CODE VARCHAR(64) NOT NULL, PRIMARY KEY (ID))
CREATE INDEX INDEX_RULE_CODE ON RULE (CODE)
...
CREATE TABLE ORDER_LINE (COMMENT VARCHAR(255), DISCOUNT FLOAT, ITEM_CODE VARCHAR(255) NOT NULL, LINE_NUMBER INTEGER NOT NULL, PRICE FLOAT, PROMOTION_DETAILS VARCHAR(255), QUANTITY INTEGER, ROOM_CODE VARCHAR(255), TOTAL_PAYMENT DECIMAL(38), ORDER_ID BIGINT)
...
ALTER TABLE PROMOTION ADD CONSTRAINT FK_PROMOTION_RULE_ID FOREIGN KEY (RULE_ID) REFERENCES RULE (ID)
...
ALTER TABLE RULE_PARAMETER ADD CONSTRAINT FK_RULE_PARAMETER_RULE_ID FOREIGN KEY (RULE_ID) REFERENCES RULE (ID)
