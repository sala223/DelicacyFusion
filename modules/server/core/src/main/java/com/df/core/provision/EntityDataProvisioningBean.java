...
public class EntityDataProvisioningBean extends TransactionalProvisioningBean implements TransactionalTasklet,
        InitializingBean {
	...
	public EntityDataProvisioningBean(String id) {
		this.id = id;
	}
