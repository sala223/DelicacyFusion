...
public class PromotionDaoTest extends MasterDataJPABaseTest {
	...
	public void sampleItemsAndPromotions() {
		...
		p1.setValidFrom(calendar.getTime());
		...
		calendar.add(Calendar.DAY_OF_YEAR, -11);
		p2.setValidFrom(calendar.getTime());
		...
		calendar.add(Calendar.DAY_OF_YEAR, -11);
		p3.setValidFrom(calendar.getTime());
	...
	@Test
	public void getValidPromotions() {
		List<Promotion> promotions = promotionDao.getValidPromotions("S1");
